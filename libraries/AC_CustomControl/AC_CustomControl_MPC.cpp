...
const AP_Param::GroupInfo AC_CustomControl_MPC::var_info[] = {
    ...
    // @User: Standard
    AP_SUBGROUPINFO(_p_angle_roll2, "ANG_RLL_", 1, AC_CustomControl_MPC, AC_P),
    ...
    // @Range{Sub}: 0.0 12.000
    // @User: Standard
    AP_SUBGROUPINFO(_p_angle_pitch2, "ANG_PIT_", 2, AC_CustomControl_MPC, AC_P),
    ...
    // @Range{Sub}: 0.0 6.000
    // @User: Standard    
    AP_SUBGROUPINFO(_p_angle_yaw2, "ANG_YAW_", 3, AC_CustomControl_MPC, AC_P),
    ...
    AP_SUBGROUPINFO(_pid_atti_rate_roll, "RAT_RLL_", 4, AC_CustomControl_MPC, AC_PID),
    ...
    AP_SUBGROUPINFO(_pid_atti_rate_pitch, "RAT_PIT_", 5, AC_CustomControl_MPC, AC_PID),
    ...
    AP_SUBGROUPINFO(_pid_atti_rate_yaw, "RAT_YAW_", 6, AC_CustomControl_MPC, AC_PID),
...
Vector3f AC_CustomControl_MPC::update()
{
...
void AC_CustomControl_MPC::set_notch_sample_rate(float sample_rate)
{
