...
# endif // AP_DDS_GPS_GLOBAL_ORIGIN_PUB_ENABLED
    ...
    // static bool update_topic(ardupilot_msgs_msg_CameraFeedback& msg);
    static bool update_topic(ardupilot_msgs_msg_CameraFeedback& msg, uint8_t camera_instance);
#endif // AP_DDS_CAMERA_FEEDBACK_PUB_ENABLED
    ...
    // static bool update_topic(ardupilot_msgs_msg_CameraCaptureStatus& msg);
    static bool update_topic(ardupilot_msgs_msg_CameraCaptureStatus& msg, uint8_t camera_instance);
#endif // AP_DDS_CAMERA_CAPTURE_STATUS_PUB_ENABLED

#if AP_DDS_CAMERA_FEEDBACK_PUB_ENABLED || AP_DDS_CAMERA_CAPTURE_STATUS_PUB_ENABLED
    // Simple camera instance tracking
    uint8_t active_camera_instance = 0;        // Currently active camera instance
#endif
